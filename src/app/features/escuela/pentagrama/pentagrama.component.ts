...
export class PentagramaComponent {
  ...
  notes: StaffNote[] = [
    { id: 'C5', name: 'Do', octave: 5, position: 10, audioNote: 'C5' },
    { id: 'D5', name: 'Re', octave: 5, position: 9, audioNote: 'D5' },
    { id: 'E5', name: 'Mi', octave: 5, position: 8, audioNote: 'E5' },
    { id: 'F5', name: 'Fa', octave: 5, position: 7, audioNote: 'F5' },
    { id: 'G5', name: 'Sol', octave: 5, position: 6, audioNote: 'G5' },
    { id: 'A5', name: 'La', octave: 5, position: 5, audioNote: 'A5' },
    { id: 'B5', name: 'Si', octave: 5, position: 4, audioNote: 'B5' },
    { id: 'C4', name: 'Do', octave: 4, position: 0, audioNote: 'C4' },
    { id: 'D4', name: 'Re', octave: 4, position: -1, audioNote: 'D4' },
    { id: 'E4', name: 'Mi', octave: 4, position: -2, audioNote: 'E4' },
    { id: 'F4', name: 'Fa', octave: 4, position: -3, audioNote: 'F4' },
    { id: 'G4', name: 'Sol', octave: 4, position: -4, audioNote: 'G4' },
  ];
